  ...
  const DisplayData = psicologo.map((info) => {
    return (
      ...
      >
        ...
        <TableCell>{info.nomPsicologo}</TableCell>
        <TableCell>{info.ap1Psicologo}</TableCell>
        <TableCell>{info.ap2Psicologo}</TableCell>
        <TableCell>{info.edadPsicologo}</TableCell>
        <TableCell>{info.sexoPsicologo}</TableCell>
